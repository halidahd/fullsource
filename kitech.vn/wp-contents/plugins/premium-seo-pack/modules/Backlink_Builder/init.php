											...
											pspAjaxListTable::getInstance( $this->the_plugin )
												->setup(array(
													...
													'notices'			=> array(
														...
														'default'			=> '<span class="psp-message psp-warning" style="display: block;">' . __('Click the Import directory rows button to get the directory index urls!', $this->the_plugin->localizationName) . '</span>'
													),
													'columns'			=> array(
														'checkbox'	=> array(
															'th'	=>  'checkbox',
													...
													'mass_actions' 	=> array(
														...
														'import' => array(
															'value' => __('Import directory rows', $this->the_plugin->localizationName),
