			...
			'seo_friendly_images' => array(
				...
				'elements'	=> array(
					...
					'image_alt' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Image Alternate text:', $psp->localizationName),
						'desc' 		=> __('Your images alternate text attribute. &lt;img src=&quot;images/&quot; width=&quot;&quot; height=&quot;&quot; <strong>alt=&quot;your_alt&quot;</strong>&gt;', $psp->localizationName)
					),
					...
					'image_title' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Image  Title text:', $psp->localizationName),
						'desc' 		=> __('Your images title text attribute. &lt;img src=&quot;images/&quot; width=&quot;&quot; height=&quot;&quot; <strong>title=&quot;your_alt&quot;</strong>&gt;', $psp->localizationName)
					),
					...
					'keep_default_alt' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Keep image alt:', $psp->localizationName),
						'desc' 		=> __('Choose if you want to keep the current images alternate text attribute.', $psp->localizationName),
						'options'	=> array(
					...
					'keep_default_title' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Keep image title:', $psp->localizationName),
						'desc' 		=> __('Choose if you want to keep the current images title text attribute.', $psp->localizationName),
						'options'	=> array(
							'yes' => __('YES', $psp->localizationName),
							'no' => __('NO', $psp->localizationName)
						)
