 ...
 echo json_encode(
	array(
		'Social_Stats' => array(
			...
			'description' => __('You’re putting a lot of effort on marketing your website trough social media? Want to know for sure if your tactics have results? ', $psp->localizationName),
