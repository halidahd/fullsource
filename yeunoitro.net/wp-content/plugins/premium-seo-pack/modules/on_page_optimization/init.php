...
?>
			...
			<div class="psp-meta-box-container" style="display:none;">
				...
				<div class="psp-tab-menu">
					...
					<a href="#twitter_cards"><?php _e('Twitter Cards', $this->the_plugin->localizationName);?></a>
				</div>
						...
						<div class="psp-dashboard-box-content psp-seo-status-container">
							<table class="form-table">
								<tbody>
									<tr>
										<td valign="top">
											<label for="psp_twc_post_thumbsize"><?php _e('Image thumb size:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
										<?php
										...
										?>
											<span><?php _e('Choose Post|Page Image Thumb Size', $this->the_plugin->localizationName);?></span>
										</td>
									</tr>
									<tr>
										<td valign="top">
											<label for="psp_twc_post_cardtype"><?php _e('Add Post|Page Twitter Card Type:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
										<?php
										...
										?>
											<span><?php _e('Choose Post|Page Twitter Card Type', $this->the_plugin->localizationName);?></span>
										</td>
									</tr>
									<tr>
										<td colspan="2">
							...
							<div class="psp-form" id="psp-twittercards-post-response">
									...
									<tr>
										<td valign="top">
											<label for="psp-field-twc-app-isactive"><?php _e('Add Twitter App Card Type:', $this->the_plugin->localizationName);?></label>
										</td>
										<td colspan="2">
							<select name="psp_twc_app_isactive" id="psp_twc_app_isactive" style="width:300px;">
								<option value="default" <?php echo $twc_app_isactive=='default' ? 'selected="true"' : ''; ?> ><?php _e('Use Website Generic App Twitter Card Type', $this->the_plugin->localizationName);?></option>
								<option value="yes" <?php echo $twc_app_isactive=='yes' ? 'selected="true"' : ''; ?> ><?php _e('Yes', $this->the_plugin->localizationName);?></option>
								<option value="no" <?php echo $twc_app_isactive=='no' ? 'selected="true"' : ''; ?> ><?php _e('No', $this->the_plugin->localizationName);?></option>
							</select>
							<!--<span><?php _e('Choose Yes if you want to add Twitter App Card Type', $this->the_plugin->localizationName);?></span>-->
										</td>
									</tr>
									<tr>
										<td colspan="2">
