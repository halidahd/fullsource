 ...
 echo json_encode(
	array(
		'monitor_404' => array(
			...
			'description' => __('On this module you can see what URLs are referring visitors to 404 pages, how many hits it had and redirect them to another page.', $psp->localizationName),
