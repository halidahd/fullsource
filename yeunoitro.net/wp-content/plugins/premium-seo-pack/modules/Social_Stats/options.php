...
function psp_social_sharing_html() {
	...
	$__toolbarTypes = array(
		'floating'			=> __('Floating Toolbar', $psp->localizationName),
		'content_horizontal'		=> __('Content Top / Bottom Toolbar', $psp->localizationName),
		'content_vertical'		=> __('Content Left / Right Toolbar', $psp->localizationName)
	);
...
<div class="psp-form-row" style="padding-top: 0; padding-bottom: 0;">
	<label style="margin-top: 7px;"><?php _e('Enabled Toolbars: ', $psp->localizationName); ?></label>
...
echo json_encode(
	array(
		$tryed_module['db_alias'] => array(
			...
			/* define the form_messages box */
			,'socialsharing' => array(
				'title' 	=> __('Social Sharing', $psp->localizationName),
				'icon' 		=> '{plugin_folder_uri}assets/menu_icon.png',
				'size' 		=> 'grid_4', // grid_1|grid_2|grid_3|grid_4
				'header' 	=> true, // true|false
				'toggler' 	=> false, // true|false
				...
				'elements'	=> array(
					'text_email' 	=> array(
						'type' 		=> 'text',
						'std' 		=> __('Email', $psp->localizationName),
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 		=> __('Email text:', $psp->localizationName),
						'desc' 		=> __('email text', $psp->localizationName)
					),
					'text_print' 	=> array(
						'type' 		=> 'text',
						'std' 		=> __('Print', $psp->localizationName),
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 		=> __('Print text:', $psp->localizationName),
						'desc' 		=> __('print text', $psp->localizationName)
					),
					'text_more' 	=> array(
						'type' 		=> 'text',
						'std' 		=> __('More', $psp->localizationName),
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 		=> __('More text:', $psp->localizationName),
						'desc' 		=> __('more text', $psp->localizationName)
					),
					'email' 	=> array(
						'type' 		=> 'text',
						'std' 		=> '',
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 		=> __('Email address:', $psp->localizationName),
						'desc' 		=> __('email address', $psp->localizationName)
					),
					'twitter_id' 	=> array(
						'type' 		=> 'text',
						'std' 		=> '',
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 		=> __('Twitter Account ID:', $psp->localizationName),
						'desc' 		=> __('Twitter Account ID', $psp->localizationName)
					),
					...
					'toolbar' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '200',
						'title' 	=> __('Social Sharing Toolbar:', $psp->localizationName),
						'desc' 		=> '&nbsp;',
						'options'	=> array(
