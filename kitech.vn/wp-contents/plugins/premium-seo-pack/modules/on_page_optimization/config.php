 ...
 echo json_encode(
	array(
		'on_page_optimization' => array(
			...
			'description' => __('This is a premium feature that will allow you to mass optimize your wordpress website in just a few clicks! It\'s the most unique feature and you will not find it anywhere else on the market.', $psp->localizationName),
