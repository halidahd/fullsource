 ...
 echo json_encode(
	array(
		'seo_friendly_images' => array(
			...
			'description' => __("How does it work? This module will automatically update all images with proper ALT and Title Attributes. If they don’t have ALT setup, the SEO Friendly Images will add them according to the options you set. ", $psp->localizationName),
