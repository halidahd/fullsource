...
function psp_TwitterCardsTypes( $istab = '' ) {
	global $psp;
...
?>
<div class="psp-form-row<?php echo ($istab!='' ? ' '.$istab : ''); ?>">
	<label><?php _e('Default Twitter Cards Type:', $psp->localizationName); ?>	</label>
	<div class="psp-form-item large">
	<span class="formNote">&nbsp;</span>
	<?php
	foreach ($post_types as $key => $value){
		...
		<select id="psp_twc_cardstype_default[<?php echo $key;?>]" name="psp_twc_cardstype_default[<?php echo $key;?>]" style="width:200px;">
			...
			<?php
			$opengraph_defaults = array(
				'summary'				=> __('Summary Card', $psp->localizationName),
				'summary_large_image'		=> __('Summary Card with Large Image', $psp->localizationName),
				'photo'					=> __('Photo Card', $psp->localizationName),
				'gallery'				=> __('Gallery Card', $psp->localizationName),
				'player'				=> __('Player Card', $psp->localizationName),
				'product'				=> __('Product Card', $psp->localizationName)
			);
			foreach ($opengraph_defaults as $k => $v){
...
function psp_TwitterCardsOptions( $istab = '', $type='' ) {
	global $psp;
	...
	ob_start();
?>
	<div class="psp-form-row<?php echo ($istab!='' ? ' '.$istab : ''); ?>" id="<?php echo $type=='home' ? 'psp-twittercards-home-response' : 'psp-twittercards-app-response'; ?>" style="position:relative;"></div>
	<script>
...
function psp_TwitterCardsImageFind($istab = '') {
	global $psp;
...
?>
<div class="psp-form-row<?php echo ($istab!='' ? ' '.$istab : ''); ?>">
	<label><?php _e('How to choose Image:', $psp->localizationName); ?></label>
	<div class="psp-form-item large">
	<span class="formNote">&nbsp;</span>
		<select id="psp_twc_image_find" name="psp_twc_image_find" style="width:350px;">
			<?php
			$image_find = array(
				'content'				=> __('Choose first image from the post | page content', $psp->localizationName),
				'featured'				=> __('Featured image for the post | page', $psp->localizationName),
				'customfield'				=> __('Choose a custom field for image', $psp->localizationName)
			);
	...
	<div class="psp-form-item small" style="margin-top:5px;">
		<span class=""><?php echo __('Choose custom field:', $psp->localizationName); ?></span>&nbsp;
			...
			'title_meta_format' => array(
				...
				'elements'	=> array(
					...
					'social_use_meta' => array(
						...
						'desc' 		=> __('Choose Yes if you want to use Facebook Open Graph Social Meta Tags in all your pages! If you choose No, you can still activate tags for a post or page in it\'s meta box.', $psp->localizationName),
						'options'	=> array(
							'yes' 	=> __('YES', $psp->localizationName),
							'no' 	=> __('NO', $psp->localizationName)
						)
					...
					'psp_twc_use_meta' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Use Twitter Cards Meta Tags:', $psp->localizationName),
						'desc' 		=> __('Choose Yes if you want to use Twitter Cards Meta Tags in all your pages! If you choose No, you can still activate tags for a post or page in it\'s meta box.', $psp->localizationName),
						'options'	=> array(
							'yes' 	=> __('YES', $psp->localizationName),
							'no' 	=> __('NO', $psp->localizationName)
						)
					...
					'psp_twc_website_account' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Website Twitter Account:', $psp->localizationName),
					...
					'psp_twc_website_account_id' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Website Twitter Account Id:', $psp->localizationName),
					...
					'psp_twc_creator_account' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Content Creator Twitter Account:', $psp->localizationName),
					...
					'psp_twc_creator_account_id' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '400',
						'title' 	=> __('Content Creator Twitter Account Id:', $psp->localizationName),
					...
					'psp_twc_cardstype_default' => array(
						'type' 		=> 'html',
						'html' 		=> psp_TwitterCardsTypes( '__tab7' )
					),
					
					'psp_twc_image_find' => array(
						'type' 		=> 'html',
						'html' 		=> psp_TwitterCardsImageFind( '__tab7' )
					),
					...
					'psp_twc_thumb_sizes' => array(
						...
						'size' 		=> 'large',
						'force_width'  => '450',
						'title' 		=> __('Image Thumbnails sizes:', $psp->localizationName),
						'desc' 		=> '&nbsp;',
						'options'	=> array(
							'none'		=> __('Don\'t make a thumbnail from the image', $psp->localizationName),
							'435x375' => __('Web: height is 375px, width is 435px', $psp->localizationName),
							'280x375' => __('Mobile (non-retina displays): height is 375px, width is 280px', $psp->localizationName),
							'560x750' => __('Mobile (retina displays): height is 750px, width is 560px', $psp->localizationName),
							'280x150' => __('Small: height is 150px, width is 280px', $psp->localizationName),
							'120x120' => __('Smallest: height is 120px, width is 120px', $psp->localizationName)
						)
					),
					...
					'psp_twc_thumb_crop' => array(
						...
						'size' 		=> 'large',
						'force_width'	=> '120',
						'title' 	=> __('Force Crop on card type Image?', $psp->localizationName),
						'desc' 		=> __('Choose Yes if you want to force crop on your twitter card type chosen image.', $psp->localizationName),
						'options'	=> array(
							'yes' 	=> __('YES', $psp->localizationName),
							'no' 	=> __('NO', $psp->localizationName)
						)
					...
					'psp_twc_site_app' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Add Twitter App Card Type: ', $psp->localizationName),
						'desc' 		=> __('Add Twitter App Card Type', $psp->localizationName),
						'options'	=> array(
							'yes' 	=> __('YES', $psp->localizationName),
							'no' 	=> __('NO', $psp->localizationName)
						)
					...
					'psp_twc_site_app_options' => array(
						'type' 		=> 'html',
						'html' 		=> psp_TwitterCardsOptions( '__tab7', 'app' )
					),
					...
					'psp_twc_home_app' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '120',
						'title' 	=> __('Homepage Add Twitter App Card Type: ', $psp->localizationName),
						'desc' 		=> __('Add Twitter App Card Type to Homepage', $psp->localizationName),
						'options'	=> array(
							'yes' 	=> __('YES', $psp->localizationName),
							'no' 	=> __('NO', $psp->localizationName)
						)
					...
					'psp_twc_home_type' => array(
						...
						'size' 		=> 'large',
						'force_width'=> '200',
						'title' 	=> __('Homepage Twitter Card Type:', $psp->localizationName),
						'desc' 		=> '&nbsp;',
						'options'	=> array(
							'none'					=> __('None', $psp->localizationName),
							'summary'				=> __('Summary Card', $psp->localizationName),
							'summary_large_image'		=> __('Summary Card with Large Image', $psp->localizationName),
							'photo'					=> __('Photo Card', $psp->localizationName),
							'gallery'				=> __('Gallery Card', $psp->localizationName),
					...
					'psp_twc_home_options' => array(
						'type' 		=> 'html',
						'html' 		=> psp_TwitterCardsOptions( '__tab7', 'home' )
					)
