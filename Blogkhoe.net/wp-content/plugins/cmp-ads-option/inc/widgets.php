...
class Cmp_ads_widget extends WP_Widget
{
	...
	{
		$widget_ops = array( 'classname' => 'cmp_ads_widget', 'description' => __( 'Widget to display Ads', 'blogkhoe' ) );
		parent::WP_Widget( false, $name = __( 'CMP Ads', 'blogkhoe' ), $widget_ops );
	}
	...
	function form( $instance )
	{
      ...
      'search'   => 'Search',
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'id_ads' ); ?>"> <?php _e( 'Select Ads', 'blogkhoe' ); ?></label>
		</p>
