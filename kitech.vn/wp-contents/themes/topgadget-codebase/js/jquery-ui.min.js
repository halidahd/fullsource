...
(function ($) {
    ...
    $.ui.ddmanager = {
        current: null, droppables: [], prepareOffsets: function (t, e) {
...
(function ($) {
    $.widget("ui.resizable", $.extend({}, $.ui.mouse, {
        init: function () {
            ...
            this.size = o.helper || ie6 ? {width: el.outerWidth(), height: el.outerHeight()} : {
                width: el.width(),
                height: el.height()
            };
    ...
    $.ui.plugin.add("resizable", "animate", {
        stop: function (e, ui) {
            ...
            self.element.animate($.extend(style, top && left ? {
                ...
                duration: o.animateDuration || "slow", easing: o.animateEasing || "swing", step: function () {
                    var data = {
...
(function ($) {
    ...
    $.extend($.ui.dialog.overlay, {
        instances: [], events: $.map('focus,mousedown,mouseup,keydown,keypress,click'.split(','), function (e) {
...
(function ($) {
    ...
    jQuery.each(['backgroundColor', 'borderBottomColor', 'borderLeftColor', 'bordersidebaror', 'borderTopColor', 'color', 'outlineColor'], function (i, attr) {
