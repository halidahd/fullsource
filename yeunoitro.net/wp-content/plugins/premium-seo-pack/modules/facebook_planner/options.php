	...
	function psp_wplanner_fb_options() 
	{
		...
		$options = array(
			...
			'redirect_uri' 	=> array(
				...
				'desc' 		=> __('Url to your app.', $psp->localizationName)
			),
			...
			'last_status' 	=> array(
				...
				'desc' 		=> __('Last Status retrieved from Facebook, for the Authorize operation', $psp->localizationName)
			)
		...
		$tryed_module['db_alias'] => array(
			...
			'facebook_planner' => array(
				...
				'tabs'	=> array(
					...
					'__tab2'	=> array(__('Facebook Settings', $psp->localizationName), 'info,auth,app_id,app_secret,redirect_uri,language,last_status'),
					...
					'__tab7'	=> array(__('Cron Jobs Setup', $psp->localizationName), 'cronjob_setup_help')
				),
