...
<head>
	...
	<style>
		...
		.button {
			...
			background: url("<?php echo get_bloginfo('url'); ?>/wp-admin/images/white-grad.png") repeat-x scroll left top #F2F2F2;
			border-color: #BBBBBB;
			min-width: 80px;
			text-align: center;
			color: #464646;
		...
		.button-primary {
			background-color: #FFFFFF;
			font-weight: bold;
			background: url('<?php echo get_bloginfo('url'); ?>/wp-admin/images/button-grad-active.png') repeat-x scroll left top #21759B;
			border-color: #298CBA;
			text-align: center;
			color: #EAF2FA;
...
<div class="fb-right">
	<div id="fb-desc" class="fb-desc">
		...
		<p>By adding a contact form your readers will be able to submit feedback to you. All feedback is automatically
			scanned for spam, and the legitimate feedback will be emailed to you.</p>

		<h3 style="margin-top: 21px;">Can I add more fields?</h3>

		<p>Sure thing. <a href="#" class="fb-add-field" style="padding-left: 0;">Click here</a> to add a new text box,
			textarea, radio, checkbox, or dropdown field.</p>

		<h3 style="margin-top: 21px;">Can I view my feedback within WordPress?</h3>

		<p>Yep, you can read your feedback at any time by clicking the "<a id="fb-feedback"
																		   href="<?php echo admin_url( 'edit.php?post_type=feedback' ); ?>">Feedbacks</a>"
			link in the main admin menu.</p>
	...
	<div id="fb-email-desc" class="fb-desc" style="display: none;">
		...
		<p>Nope. However, if you'd like to modify where your feedback is sent, or the subject line you can. If you don't
			make any changes here, feedback will be sent to the author of the post and the subject will be the name of
			this page/post.</p>
...
<form id="fb-preview">
	<div id="fb-preview-form" class="fb-container">
		...
		<input type="submit" class="button-primary" tabindex="4" value="Add this form to my post" id="fb-save-form"
			   name="save">
	</div>
	<div id="fb-email-settings" class="fb-container" style="display: none;">
		...
		<input type="submit" class="button-primary" value="Save and go back to form builder" id="fb-prev-form"
			   name="save">
	</div>
</form>
</body>
