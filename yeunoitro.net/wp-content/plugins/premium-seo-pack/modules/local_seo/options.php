			...
			'local_seo' => array(
				...
				'elements'	=> array(
					'xmlsitemap_html' => array(
						...
						'html' 		=> 
							'<div class="psp-form-row">
								<label for="site-items">' . __('Local SEO - locations', $psp->localizationName) . '</label>
								...
								<label for="site-items">' . __('Validators', $psp->localizationName) . '</label>
								<div class="psp-form-item large">
					...
					/*'google_map_api_key' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '350',
						'title' 	=> __('Google Maps API Key:', $psp->localizationName),
						'desc' 		=> __('Here you can enter Google Maps API Console Key, recommended by <a href="https://developers.google.com/maps/documentation/javascript/tutorial?hl=en#api_key" target="_blank">Google Tutorial</a>', $psp->localizationName)
					)*/
					,'slug' 	=> array(
						'type' 		=> 'text',
						'std' 		=> 'psplocation',
						'size' 		=> 'small',
						'force_width'=> '350',
						'title' 	=> __('Slug: ', $psp->localizationName),
						'desc' 		=> __('Custom Slug for your Locations', $psp->localizationName)
					)
					...
					,'address_format' 	=> array(
						...
						'size' 		=> 'large',
						'force_width'=> '350',
						'title' 	=> __('Address Format: ', $psp->localizationName),
						'desc' 		=> __('You can use the following tags: {street} {city}, {state} {zipcode} {country}. This format is used for kml sitemap generation and for address shortcode. <!--Also {street} is included first by default and {country} is included last by default in this format and you must not include them.-->', $psp->localizationName)
					)
				)
			)
